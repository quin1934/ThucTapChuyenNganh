    ...
    <div class="container">
        <div class="row g-5">
                ...
                <div class="about-item">
                    ...
                    <div class="row g-4">
                        <div class="col-lg-6">
                            <div class="about-item-inner border p-4">
                                <div class="about-icon mb-4">
                                    <img src="{{ asset('img/about-icon-1.png') }}" class="img-fluid w-50 h-50" alt="Icon">
                                </div>
                        ...
                        <div class="col-lg-6">
                            <div class="about-item-inner border p-4">
                                <div class="about-icon mb-4">
                                    <img src="{{ asset('img/about-icon-2.png') }}" class="img-fluid h-50 w-50" alt="Icon">
                                </div>
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-lg-7">
                            <div class="d-flex align-items-center">
                                <img src="{{ asset('img/attachment-img.jpg') }}" class="img-fluid rounded-circle border border-4 border-secondary" style="width: 100px; height: 100px;" alt="Image">
                                <div class="ms-4">
            ...
            <div class="col-xl-6 wow fadeInRight" data-wow-delay="0.2s">
                <div class="about-img">
                    <div class="img-1">
                        <img src="{{ asset('img/about-img.jpg') }}" class="img-fluid rounded h-100 w-100" alt="">
                    </div>
                    <div class="img-2">

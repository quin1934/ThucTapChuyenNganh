    ...
    <div class="container-fluid">
        ...
        <div class="card shadow">
            <div class="card-header">
                <h6 class="m-0 font-weight-bold text-primary">Tạo khuyến mãi</h6>
            </div>
            <div class="card-body">
                            ...
                            <select name="ma_xe" class="form-control">
                                ...
                                @foreach ($cars as $c)
                                    <option value="{{ $c->Ma_Xe }}"
                                        {{ (string) old('ma_xe') === (string) $c->Ma_Xe ? 'selected' : '' }}>
                                        {{ $c->Ten_Xe }} (ID: {{ $c->Ma_Xe }})
                                    </option>
                                @endforeach
                            </select>
                            ...
                            <select name="ma_plxe" class="form-control">
                                ...
                                @foreach ($categories as $cat)
                                    <option value="{{ $cat->Ma_PLXe }}"
                                        {{ (string) old('ma_plxe') === (string) $cat->Ma_PLXe ? 'selected' : '' }}>
